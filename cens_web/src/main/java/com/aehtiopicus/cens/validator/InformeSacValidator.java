...
@Service
public class InformeSacValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		InformeConsolidado ic = informeConsolidadoService.getByPeriodoAndTipo(p, InformeConsolidadoTipoEnum.SAC);
		if(ic != null) {
