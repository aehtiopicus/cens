...
public class InformeConsolidado implements Serializable {
	...
	protected List<InformeConsolidadoDetalle> detalle;
	...
	public List<InformeConsolidadoDetalle> getDetalle() {
		if(detalle == null) {
			detalle = new ArrayList<InformeConsolidadoDetalle>();
		}
		return detalle;
	}

	public void setDetalle(List<InformeConsolidadoDetalle> detalle) {
